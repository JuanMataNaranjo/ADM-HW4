...
def string_to_binary_list(list_users):
    """
    Function to convert list of strings into binary using the first hash function

    :param list: List in which strings (User_IDs) are contained
    :return: List with binary values
    """

    list_ = [string_to_binary_hash(x) for x in list_users]
